...
// src/data/questionnaire.js
//
// ⚠ REFERENCE ONLY — this file is no longer the content source.
//
// As of S3-11 (Phase 1b Strangler Fig migration), questionnaire content is
// loaded from 6 JSON files in src/data/:
//   - questions.json
//   - episodes.json
//   - tiers.json
//   - ui-copy.json
...
//   - taxonomy.json
//
// This .js file is retained as the original source of truth for the migration
// audit trail and as a fallback reference. Do NOT edit this file to change
// runtime behaviour — edits made here have no effect on the application.
// To change content, edit the corresponding JSON file.
//
// Phase 1a (Sprint 2 → end of Sprint 3 testing): this file was the source
// Phase 1b (S3-11 onwards):                       JSON files are the source
// Phase 2 (later):                                Supabase will be the source
//
// The useQuestionnaire hook (src/hooks/useQuestionnaire.js) is the only
// import boundary — components never touch this file directly.

// ─────────────────────────────────────────────────────────────────────────
// Original file content follows below — do NOT modify (see note above).
// ─────────────────────────────────────────────────────────────────────────

// (existing content of questionnaire.js preserved unchanged — only this
// header comment block is added above the existing 'const questionnaire = {'
// declaration. The const, the export, and all 80 questions stay exactly as
// they were. The file is no longer imported by anything in the application;
// it is preserved purely as a reference artefact.)
...
const questionnaire = {
  questions: [
    ...
    // ── Q0 — Tense Routing Gate ──────────────────────────────────────────
    {
      ...
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
...

    {
      ...
      options: [
        ...
        { code: 'H', taxonomy_code: 'DISP-TRANS',  text: 'Personal necessity — a private space needed during a difficult personal circumstance' },
      ...
      has_none_option: true, max_selections: null, routes_module_5: true, module_5_code: 'taxonomy_code',
      researcher_note: 'Q1 intent capture. taxonomy_code → intent_category in sessions. Drives Module 5 routing.',
    },
    {
      id: 'Q2', module: 1, section: '1A',
    ...
    },
    {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: 'UNPLANNED',    text: 'Same day or within 24 hours — it was entirely unplanned' },
        { code: 'B', taxonomy_code: 'UNPLANNED',    text: '1–3 days ahead — it came up with very little notice' },
        { code: 'C', taxonomy_code: 'SEMI-PLANNED', text: '4–14 days ahead — relatively short notice' },
        { code: 'D', taxonomy_code: 'PLANNED',      text: '2–6 weeks ahead — moderate advance planning' },
        { code: 'E', taxonomy_code: 'PLANNED',      text: '1–3 months ahead — planned well in advance' },
        { code: 'F', taxonomy_code: 'LONG-LEAD',    text: 'More than 3 months ahead — long-range planning' },
        { code: 'G', taxonomy_code: null,            text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
    ...
    },
    {
      ...
      options: [
        { code: 'A', taxonomy_code: 'FORCED-DISP',  text: 'My home or usual accommodation was unavailable' },
        { code: 'B', taxonomy_code: 'CONVENIENCE',  text: 'The hotel was the most convenient option given the location' },
        { code: 'C', taxonomy_code: 'PRIVACY',      text: 'I wanted privacy or separation from my usual environment' },
        { code: 'D', taxonomy_code: 'MANDATED',     text: 'Someone else arranged or required the hotel stay (employer, event organiser, family)' },
        { code: 'E', taxonomy_code: 'AMENITY-PULL', text: "I wanted dedicated amenities I don't have at home" },
        { code: 'F', taxonomy_code: 'EXPERIENTIAL', text: 'I wanted the experience itself — the hotel was part of the occasion' },
        { code: 'G', taxonomy_code: 'ECONOMIC',     text: 'Cost or availability made it the most practical choice' },
        { code: 'H', taxonomy_code: 'PROXIMITY',    text: 'I needed to be close to a specific person, place, or facility' },
    ...
    },
    {
      ...
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: 'SOLO | COUPLE | FAM-YOUNG | FAM-TEEN | FRIEND-GRP | CORP-GRP | MULTI-GEN | MIXED',
    },
    {
      id: 'Q6', module: 1, section: '1C',
      tiers: ['professional', 'expert'],
      type: 'single_select',
      text: {
      ...
      options: [
        ...
        { code: 'B', taxonomy_code: null, text: 'Two rooms — for privacy or different sleeping configurations' },
    ...
    },
    {
      ...
      options: [
        ...
        { code: 'F', taxonomy_code: 'LONG-PROJ', text: '15–30 nights — long-term project or assignment' },
    ...
    {
      id: 'Q8', module: 1, section: '1E',
      tiers: ['professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: 'Before choosing a hotel, what other accommodation options did you seriously consider?',
        anticipatory:  'Before choosing a hotel, what other accommodation options are you seriously considering?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: 'NO-ALT',        text: 'None — the hotel was the obvious choice from the start' },
        { code: 'B', taxonomy_code: 'STR',            text: 'A short-term rental apartment (e.g. Airbnb, VRBO, serviced apartment)' },
        { code: 'C', taxonomy_code: 'SOCIAL',         text: 'Staying with friends or family' },
        { code: 'D', taxonomy_code: 'CORP-HOUSING',   text: 'A company-managed or employer-provided apartment' },
        { code: 'E', taxonomy_code: 'BUDGET-LODGE',   text: 'A hostel, guesthouse, or budget lodging' },
        { code: 'F', taxonomy_code: 'HOTEL-SWITCH',   text: 'A different hotel or hotel category' },
        { code: 'G', taxonomy_code: 'AVOIDED-TRAVEL', text: 'Not traveling at all — managing the situation another way' },
        { code: 'H', taxonomy_code: null,              text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Reliability and consistency — I knew what I was getting' },
        { code: 'B', taxonomy_code: null, text: 'Location — the hotel was where I needed to be' },
        { code: 'C', taxonomy_code: null, text: 'Amenities or services I required (gym, F&B, meeting space, etc.)' },
        { code: 'D', taxonomy_code: null, text: 'Privacy and professionalism of the environment' },
        { code: 'E', taxonomy_code: null, text: 'Ease of booking and flexibility (check-in, cancellation, extension)' },
        { code: 'F', taxonomy_code: null, text: 'Loyalty points, corporate rate, or someone else was paying' },
        { code: 'G', taxonomy_code: null, text: 'It was the only practical option available at the time' },
        { code: 'H', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
...

    {
      ...
      options: [
        ...
        { code: 'B', taxonomy_code: null, text: 'Online travel agency (e.g. Booking.com, Expedia, Hotels.com)' },
        { code: 'C', taxonomy_code: null, text: 'Recommendation from someone I trust — colleague, friend, or family' },
        { code: 'D', taxonomy_code: null, text: "My company's travel management system or travel agent" },
        { code: 'E', taxonomy_code: null, text: 'Loyalty programme — I always stay within this brand' },
        { code: 'F', taxonomy_code: null, text: 'Search engine or review site (e.g. TripAdvisor, Google)' },
        { code: 'G', taxonomy_code: null, text: 'Social media or influencer content' },
        { code: 'H', taxonomy_code: null, text: 'I have stayed here before and returned by choice' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      options: [
        ...
        { code: 'E', taxonomy_code: null, text: 'Specific amenities listed (gym, pool, restaurant, workspace)' },
        { code: 'F', taxonomy_code: null, text: 'Cancellation and flexibility policies' },
        { code: 'G', taxonomy_code: null, text: 'Brand reputation or loyalty programme affiliation' },
      ...
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q12', module: 2, section: '2A',
      tiers: ['expert'],
      type: 'scale_5',
      text: {
        retrospective: 'How important is it that the hotel acknowledges your booking and communicates before arrival?',
        anticipatory:  'How important is it that the hotel acknowledges your booking and communicates before arrival?',
      },
      instruction: null,
      scale_labels: ['Not important', 'Slightly important', 'Moderately important', 'Very important', 'Essential'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q13', module: 2, section: '2A',
      tiers: ['expert'],
      type: 'multi_select',
      text: {
      ...
      options: [
        { code: 'A', taxonomy_code: null, text: 'Booking confirmation with all key details clearly summarised' },
        { code: 'B', taxonomy_code: null, text: 'Information about check-in options — time, digital key, express' },
        { code: 'C', taxonomy_code: null, text: 'Directions and transport options to the hotel' },
        { code: 'D', taxonomy_code: null, text: 'Offers to pre-arrange services — dining, transfers, special setups' },
        { code: 'E', taxonomy_code: null, text: "Information about the hotel's amenities and how to access them" },
        { code: 'F', taxonomy_code: null, text: 'Local area guide — restaurants, attractions, practicalities' },
        { code: 'G', taxonomy_code: null, text: 'A reminder close to arrival with any updates' },
        { code: 'H', taxonomy_code: null, text: 'I prefer no pre-arrival contact beyond a booking confirmation' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 2, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q14', module: 2, section: '2B',
      tiers: ['amateur', 'professional', 'expert'],
      type: 'single_select',
      text: {
      ...
      options: [
        ...
        { code: 'D', taxonomy_code: null, text: '18:00–22:00 — evening arrival after work or travel' },
    ...
    },
    {
      ...
      instruction: null,
      scale_labels: ['Not important', 'Nice to have', 'Moderately important', 'Very important', 'I require it'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q16', module: 2, section: '2B',
      tiers: ['amateur', 'professional', 'expert'],
      type: 'single_select',
      text: {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Traditional front desk check-in — I want to be welcomed personally' },
        { code: 'B', taxonomy_code: null, text: 'Express front desk — fast and efficient, minimal conversation' },
        { code: 'C', taxonomy_code: null, text: 'Digital / mobile check-in — completed before arrival, key on my phone' },
    ...
    },
    {
      ...
      options: [
        ...
        { code: 'D', taxonomy_code: null, text: 'On foot — the hotel is very close to my destination' },
    ...
    {
      id: 'Q18', module: 2, section: '2C',
      tiers: ['expert'],
      type: 'single_select',
      text: {
        retrospective: 'How easy was it to communicate any special requirements to the hotel before arrival?',
        anticipatory:  'How easy do you expect it to be to communicate any special requirements to the hotel before arrival?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Very easy — the booking process made it simple' },
        { code: 'B', taxonomy_code: null, text: 'Somewhat easy — I found a way to communicate my needs' },
        { code: 'C', taxonomy_code: null, text: 'Neutral — I had no special requirements to communicate' },
        { code: 'D', taxonomy_code: null, text: 'Somewhat difficult — it required extra effort' },
        { code: 'E', taxonomy_code: null, text: 'Very difficult — the hotel made it hard to convey what I needed' },
        { code: 'F', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: 'Surfaces accessibility friction without asking about the nature of the requirement.',
    },
...

    {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Standard room — clean, functional, no frills needed' },
        { code: 'B', taxonomy_code: null, text: 'A room with a workspace that genuinely works — desk, good lighting, outlets' },
        { code: 'C', taxonomy_code: null, text: 'A room with a dedicated sitting or lounge area' },
        { code: 'D', taxonomy_code: null, text: 'A suite or larger room — I need space to spread out or entertain' },
        { code: 'E', taxonomy_code: null, text: 'A room configured for two people with appropriate sleeping arrangements' },
        { code: 'F', taxonomy_code: null, text: 'A family room or interconnecting rooms' },
        { code: 'G', taxonomy_code: null, text: 'A long-stay or apartment-style room with kitchen facilities' },
        { code: 'H', taxonomy_code: null, text: 'A room with a specific view or physical characteristic' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Very important — I have a strong preference (high floor, quiet side, corner, etc.)' },
        { code: 'B', taxonomy_code: null, text: 'Somewhat important — I would prefer but will not insist' },
        { code: 'C', taxonomy_code: null, text: 'Indifferent — room quality matters more than position' },
        { code: 'D', taxonomy_code: null, text: 'I prefer lower floors — easier access, less dependent on lifts' },
        { code: 'E', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      instruction: 'Select up to three.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'Bedding and linen — visibly clean and freshly laundered' },
        { code: 'B', taxonomy_code: null, text: 'Bathroom hygiene — toilet, shower, and surfaces spotless' },
        { code: 'C', taxonomy_code: null, text: 'No visible evidence of previous guests' },
        { code: 'D', taxonomy_code: null, text: 'Air quality — no musty, chemical, or unpleasant odours' },
        { code: 'E', taxonomy_code: null, text: 'Floor and carpet cleanliness' },
        { code: 'F', taxonomy_code: null, text: 'High-touch surfaces — remote controls, door handles, phones' },
        { code: 'G', taxonomy_code: null, text: 'Minibar, coffee area, and glassware hygiene' },
        { code: 'H', taxonomy_code: null, text: 'Overall sense of freshness upon entering the room' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'I want daily full housekeeping — it is part of what I am paying for' },
        { code: 'B', taxonomy_code: null, text: 'I want housekeeping every other day — a reasonable balance' },
        { code: 'C', taxonomy_code: null, text: 'I prefer minimal housekeeping — only when I explicitly request it' },
        { code: 'D', taxonomy_code: null, text: 'I do not want anyone entering my room unless absolutely necessary' },
        { code: 'E', taxonomy_code: null, text: 'I want full control over when and how often housekeeping comes' },
        { code: 'F', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      instruction: null,
      scale_labels: ['Not sensitive — I sleep through anything', 'Slightly sensitive', 'Moderately sensitive', 'Very sensitive', 'Extremely sensitive — noise ruins my stay'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q24', module: 3, section: '3C',
      tiers: ['professional', 'expert'],
      type: 'multi_select',
      text: {
      ...
      options: [
        { code: 'A', taxonomy_code: null, text: 'Noise from other guests — corridors, adjacent rooms, above/below' },
        { code: 'B', taxonomy_code: null, text: 'Street noise — traffic, construction, nightlife' },
        { code: 'C', taxonomy_code: null, text: 'HVAC systems — air conditioning or heating noise' },
    ...
    },
    {
      ...
      instruction: null,
      scale_labels: ['Not important', 'Slightly important', 'Moderately important', 'Very important', 'Significantly affects my sleep / wellbeing'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q27', module: 3, section: '3D',
      tiers: ['amateur', 'professional', 'expert'],
      type: 'single_select',
      text: {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Essential and a dealbreaker if unreliable — I depend on it professionally' },
        { code: 'B', taxonomy_code: null, text: 'Very important — I use it heavily for personal and professional needs' },
        { code: 'C', taxonomy_code: null, text: 'Moderately important — I use it for streaming and browsing' },
        { code: 'D', taxonomy_code: null, text: 'Somewhat important — I check messages and emails' },
    ...
    },
    {
      ...
      instruction: 'Select up to three.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'Sufficient power outlets and USB ports near the bed and desk' },
        { code: 'B', taxonomy_code: null, text: 'Smart TV with streaming apps or ability to cast from my device' },
        { code: 'C', taxonomy_code: null, text: 'In-room controls for lighting, temperature, and blackout blinds' },
        { code: 'D', taxonomy_code: null, text: 'A Bluetooth speaker or good audio system' },
        { code: 'E', taxonomy_code: null, text: 'A landline phone for easy room-to-hotel communication' },
        { code: 'F', taxonomy_code: null, text: 'In-room tablet or control panel for hotel services' },
    ...
    },
    {
      ...
      instruction: null,
      scale_labels: ['Not important', 'Slightly important', 'Moderately important', 'Very important', 'A major factor in my hotel choice'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q30', module: 3, section: '3E',
      tiers: ['expert'],
      type: 'multi_select',
      text: {
      ...
      options: [
        ...
        { code: 'B', taxonomy_code: null, text: 'Electronic or digital door locks with no visible compromise' },
        { code: 'C', taxonomy_code: null, text: 'Controlled access to guest floors — key card barriers' },
        { code: 'D', taxonomy_code: null, text: '24-hour visible security or front desk presence' },
        { code: 'E', taxonomy_code: null, text: 'Privacy features — do not disturb signage, door reinforcement' },
    ...
    {
      id: 'Q31', module: 4, section: '4A',
      tiers: ['amateur', 'professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: 'How much human interaction did you want from hotel staff during this type of stay?',
        anticipatory:  'How much human interaction do you want from hotel staff during this type of stay?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: 'HIGH-TOUCH',   text: 'High-touch — I enjoy being recognised, greeted warmly, and engaged throughout' },
        { code: 'B', taxonomy_code: 'ATTENTIVE',    text: 'Professional and attentive — available when I need them, not intrusive' },
        { code: 'C', taxonomy_code: 'EFFICIENT',    text: 'Minimal and efficient — handle my needs quickly, otherwise leave me alone' },
        { code: 'D', taxonomy_code: 'INVISIBLE',    text: 'Invisible — I prefer technology-mediated service and minimal human contact' },
        { code: 'E', taxonomy_code: 'CONTEXT-DEP',  text: 'It depends strongly on the time of day and what I am doing' },
        { code: 'F', taxonomy_code: null,            text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
    ...
    {
      id: 'Q32', module: 4, section: '4A',
      tiers: ['professional', 'expert'],
      type: 'scale_5',
      text: {
        retrospective: 'How important was it that staff recognised you and recalled preferences from previous stays?',
        anticipatory:  'How important is it that staff recognise you and recall preferences from previous stays?',
      },
      instruction: null,
      scale_labels: ['Unimportant — I prefer anonymity', 'Slightly important', 'Moderately important', 'Very important', 'One of the most important service qualities'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q33', module: 4, section: '4A',
      tiers: ['expert'],
      type: 'single_select',
      text: {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Calling the front desk or a dedicated service line' },
        ...
        { code: 'E', taxonomy_code: null, text: 'I prefer not to request anything — I like things to be pre-arranged' },
        { code: 'F', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      ...
      instruction: 'Select up to three.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'Speed and efficiency — they get things done without delay' },
        { code: 'B', taxonomy_code: null, text: 'Genuine warmth and friendliness' },
        { code: 'C', taxonomy_code: null, text: 'Local knowledge — can advise on the area, restaurants, transport' },
        { code: 'D', taxonomy_code: null, text: 'Discretion — they respect my privacy and do not over-engage' },
        { code: 'E', taxonomy_code: null, text: 'Problem-solving ability — handles issues without over-complicating them' },
        { code: 'F', taxonomy_code: null, text: 'Language ability — communicates clearly in my language' },
        { code: 'G', taxonomy_code: null, text: 'Attentiveness without being asked — they anticipate my needs' },
    ...
    {
      id: 'Q35', module: 4, section: '4C',
      tiers: ['amateur', 'professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: 'When something went wrong during a stay, what mattered most in how the hotel responded?',
        anticipatory:  'When something goes wrong during a stay, what matters most in how the hotel responds?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Speed of response — fix it immediately' },
        { code: 'B', taxonomy_code: null, text: 'A genuine apology and acknowledgment that something went wrong' },
        { code: 'C', taxonomy_code: null, text: 'A concrete solution, not just words' },
        { code: 'D', taxonomy_code: null, text: 'Compensation or goodwill gesture proportionate to the problem' },
        { code: 'E', taxonomy_code: null, text: 'Evidence it will not happen again — systemic fix, not just a patch' },
        { code: 'F', taxonomy_code: null, text: 'I do not have to repeat myself or escalate to get results' },
        { code: 'G', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    ...
    {
      id: 'Q36', module: 4, section: '4C',
      tiers: ['professional', 'expert'],
      type: 'scale_5',
      text: {
        retrospective: 'How likely were you to give the hotel a second chance if a problem was handled exceptionally well?',
        anticipatory:  'How likely are you to give the hotel a second chance if a problem was handled exceptionally well?',
      },
      instruction: null,
      scale_labels: ['Very unlikely', 'Unlikely', 'Neutral', 'Likely', 'Very likely — good recovery builds loyalty'],
      options: [],
      has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    },
    {
      id: 'Q37', module: 4, section: '4D',
      tiers: ['professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: 'How much did you want the hotel to personalise your experience based on your history or stated preferences?',
        anticipatory:  'How much do you want the hotel to personalise your experience based on your history or stated preferences?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Extensively — I want to feel known and individually catered for' },
        { code: 'B', taxonomy_code: null, text: 'Moderately — acknowledge my preferences without making it feel intrusive' },
        { code: 'C', taxonomy_code: null, text: 'Minimally — just remember the basics (room type, dietary needs)' },
        { code: 'D', taxonomy_code: null, text: 'Not at all — I prefer each stay to be treated independently' },
        { code: 'E', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    ...
    {
      id: 'Q38', module: 4, section: '4D',
      tiers: ['expert'],
      type: 'single_select',
      text: {
        retrospective: 'How comfortable were you with the hotel storing your personal preferences to improve future stays?',
        anticipatory:  'How comfortable are you with the hotel storing your personal preferences to improve future stays?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Fully comfortable — the more they know, the better my experience' },
        { code: 'B', taxonomy_code: null, text: 'Comfortable with basic operational preferences only (room type, dietary needs)' },
        { code: 'C', taxonomy_code: null, text: 'Neutral — I have not thought about this' },
        { code: 'D', taxonomy_code: null, text: 'Slightly uncomfortable — I prefer minimal data storage' },
        { code: 'E', taxonomy_code: null, text: 'Very uncomfortable — I do not want my preferences stored' },
        { code: 'F', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
      researcher_note: null,
    ...
    // ── 5A — WORK & BUSINESS [WORK-TRANS | WORK-EVENT | WORK-EXT] ────────
    {
      ...
      instruction: null,
      scale_labels: ['Irrelevant', 'Nice to have', 'Moderately important', 'Very important', 'Essential — my productivity depends on it'],
      options: [], has_none_option: false, max_selections: null,
      routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q40', module: 5, section: '5A',
      intent_codes: ['WORK-TRANS', 'WORK-EVENT', 'WORK-EXT'],
      tiers: ['professional', 'expert'],
      type: 'multi_select',
      text: {
      ...
      options: [
        ...
        { code: 'C', taxonomy_code: null, text: 'Good desk lighting that does not cause eye strain' },
        { code: 'D', taxonomy_code: null, text: 'Multiple power outlets and USB ports at desk level' },
        { code: 'E', taxonomy_code: null, text: 'A large monitor or ability to connect my laptop to the TV' },
        { code: 'F', taxonomy_code: null, text: 'Quiet environment with strong sound insulation' },
        { code: 'G', taxonomy_code: null, text: 'A phone/video call-friendly background and acoustics' },
        { code: 'H', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q41', module: 5, section: '5A',
      intent_codes: ['WORK-TRANS', 'WORK-EVENT', 'WORK-EXT'],
      tiers: ['expert'],
      type: 'single_select',
      text: {
      ...
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Yes — I needed a private meeting room for professional meetings' },
        { code: 'B', taxonomy_code: null, text: 'Yes — I needed a co-working lounge or business centre' },
        { code: 'C', taxonomy_code: null, text: 'Possibly — it would be useful but is not essential' },
    ...
    {
      id: 'Q42', module: 5, section: '5A',
      intent_codes: ['WORK-TRANS', 'WORK-EVENT', 'WORK-EXT'],
      tiers: ['professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: "How important was the hotel's food and beverage offering for your work-related stay?",
        anticipatory:  "How important is the hotel's food and beverage offering for work-related stays?",
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Very important — I entertain clients or colleagues at the hotel' },
        { code: 'B', taxonomy_code: null, text: 'Important — I rely on room service and in-hotel dining when working late' },
        { code: 'C', taxonomy_code: null, text: 'Moderate — breakfast matters; I dine out for other meals' },
        { code: 'D', taxonomy_code: null, text: 'Minimal — I primarily eat outside the hotel' },
        { code: 'E', taxonomy_code: null, text: 'Not important — I manage my own food arrangements' },
        { code: 'F', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q43', module: 5, section: '5A',
      intent_codes: ['WORK-EXT'],
      tiers: ['expert'],
      type: 'multi_select',
      text: {
        retrospective: 'For extended work stays of seven or more nights, which features became important?',
        anticipatory:  'For extended work stays of seven or more nights, which features become important?',
      },
      instruction: 'Select all that apply.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'In-room laundry or on-site laundry service' },
        { code: 'B', taxonomy_code: null, text: 'A kitchenette or ability to store and prepare basic food' },
        { code: 'C', taxonomy_code: null, text: 'A gym or fitness facility for daily routine maintenance' },
        { code: 'D', taxonomy_code: null, text: 'A sense of routine and familiarity — consistent staff and processes' },
        { code: 'E', taxonomy_code: null, text: 'Grocery or essential supplies deliverable to the room' },
        { code: 'F', taxonomy_code: null, text: 'A quieter, more residential atmosphere — less hotel bustle' },
        { code: 'G', taxonomy_code: null, text: 'Flexible billing — weekly invoicing, expense-ready receipts' },
        { code: 'H', taxonomy_code: null, text: 'This section does not apply — my stay is short-term' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null,
    ...
    {
      id: 'Q44', module: 5, section: '5B',
      intent_codes: ['LEIS-PLAN', 'LEIS-SOC', 'LEIS-EXP'],
      tiers: ['amateur', 'professional', 'expert'],
      type: 'multi_select',
      text: {
        retrospective: 'For leisure stays, which hotel attributes contributed most to the overall experience?',
        anticipatory:  'For leisure stays, which hotel attributes contribute most to the overall experience?',
      },
      instruction: 'Select up to three.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'The sense of arrival — first impression, lobby atmosphere, warm welcome' },
        { code: 'B', taxonomy_code: null, text: 'Room quality and comfort — this is where I recharge' },
        { code: 'C', taxonomy_code: null, text: 'Food and beverage — quality dining is part of the leisure experience' },
        { code: 'D', taxonomy_code: null, text: 'Recreational amenities — pool, spa, gym, outdoor space' },
        { code: 'E', taxonomy_code: null, text: 'Location and proximity to attractions, nightlife, or nature' },
        { code: 'F', taxonomy_code: null, text: 'Design and aesthetic — the hotel is beautiful and distinctive' },
        { code: 'G', taxonomy_code: null, text: 'Exclusivity or a sense of being somewhere special' },
        { code: 'H', taxonomy_code: null, text: 'Family-friendliness — appropriate for children or mixed-age groups' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q45', module: 5, section: '5B',
      intent_codes: ['LEIS-PLAN', 'LEIS-SOC', 'LEIS-EXP'],
      tiers: ['professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: "How important was the hotel's food and beverage offering for your leisure stay?",
        anticipatory:  "How important is the hotel's food and beverage offering for leisure stays?",
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Central to the experience — I planned to dine in-hotel significantly' },
        { code: 'B', taxonomy_code: null, text: 'Important — at least breakfast and one other meal should be excellent' },
        { code: 'C', taxonomy_code: null, text: 'Moderate — breakfast matters most; I prefer to explore outside for other meals' },
        { code: 'D', taxonomy_code: null, text: 'Minimal — I use the hotel for sleeping and spend time elsewhere' },
        { code: 'E', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: null, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q46', module: 5, section: '5B',
      intent_codes: ['LEIS-SOC'],
      tiers: ['expert'],
      type: 'multi_select',
      text: {
        retrospective: 'For stays tied to a specific occasion, what must the hotel get right above all else?',
        anticipatory:  'For stays tied to a specific occasion, what must the hotel get right above all else?',
      },
      instruction: 'Select up to two.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'Acknowledgment of the occasion — recognition from staff' },
        { code: 'B', taxonomy_code: null, text: 'Room setup or in-room amenity tied to the occasion' },
        { code: 'C', taxonomy_code: null, text: 'Discretion — treating it as special without over-engineering it' },
        { code: 'D', taxonomy_code: null, text: 'Reliability — nothing goes wrong on an important day' },
    ...
    {
      id: 'Q47', module: 5, section: '5C',
      intent_codes: ['DISP-HOME', 'DISP-TRANS'],
      tiers: ['amateur', 'professional', 'expert'],
      type: 'multi_select',
      text: {
        retrospective: 'When staying for practical or logistical reasons outside your normal routine, what mattered most?',
        anticipatory:  'When staying for practical or logistical reasons outside your normal routine, what matters most?',
      },
      instruction: 'Select up to three.',
      options: [
        { code: 'A', taxonomy_code: 'RELIABILITY',    text: 'Reliability — I need to know exactly what to expect, with no surprises' },
        { code: 'B', taxonomy_code: 'NORMALCY',       text: 'A sense of normalcy — routines and comfort to maintain stability' },
        { code: 'C', taxonomy_code: 'FLEX',            text: 'Flexibility — ability to extend or modify the stay without friction' },
        { code: 'D', taxonomy_code: 'PRIVACY-SENS',   text: 'Privacy and discretion — minimal questions, no unnecessary engagement' },
        { code: 'E', taxonomy_code: 'EFFICIENCY',     text: 'Efficiency in all processes — checking in, accessing services, checking out' },
        { code: 'F', taxonomy_code: 'PROXIMITY',      text: 'Proximity to a specific place I need to be regularly' },
        { code: 'G', taxonomy_code: 'LONG-STAY-LIVE', text: 'A homely feel — enough space and facilities to live, not just sleep' },
        { code: 'H', taxonomy_code: null,              text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null,
      researcher_note: 'RELIABILITY | NORMALCY | FLEX | PRIVACY-SENS | EFFICIENCY | PROXIMITY | LONG-STAY-LIVE',
    },
    {
      id: 'Q48', module: 5, section: '5C',
      intent_codes: ['DISP-HOME', 'DISP-TRANS'],
      tiers: ['professional', 'expert'],
      type: 'single_select',
      text: {
        retrospective: 'How important was long-term rate or stay flexibility when a stay extended beyond your original expectation?',
        anticipatory:  'How important is long-term rate or stay flexibility when a stay extends beyond the original expectation?',
      },
      instruction: null,
      options: [
        { code: 'A', taxonomy_code: null, text: 'Very important — the hotel must accommodate extended stays at a fair rate' },
        { code: 'B', taxonomy_code: null, text: 'Important — some flexibility and goodwill goes a long way' },
        { code: 'C', taxonomy_code: null, text: 'Moderate — I can manage if given reasonable notice of rate changes' },
    ...
    // ── 5D — MEDICAL [MED] ───────────────────────────────────────────────
    {
      id: 'Q49', module: 5, section: '5D',
      intent_codes: ['MED'],
      tiers: ['amateur', 'professional', 'expert'],
      type: 'multi_select',
      text: {
        retrospective: 'When staying near a hospital, clinic, or health facility, which practical hotel features became most important?',
        anticipatory:  'When staying near a hospital, clinic, or health facility, which practical hotel features become most important?',
      },
      instruction: 'Select up to three.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'Location — walking distance or easy transport to the facility' },
        { code: 'B', taxonomy_code: null, text: 'Quiet environment — I need undisturbed rest above all else' },
        { code: 'C', taxonomy_code: null, text: 'Flexible meal options — access to food at irregular hours' },
        { code: 'D', taxonomy_code: null, text: 'Reliable transportation access — taxis and rideshares at any hour' },
        { code: 'E', taxonomy_code: null, text: 'Privacy — minimal interaction and discreet service' },
        { code: 'F', taxonomy_code: null, text: 'Extended checkout or early check-in flexibility' },
        { code: 'G', taxonomy_code: null, text: 'A calm, unhurried atmosphere — not a busy, loud hotel' },
        { code: 'H', taxonomy_code: null, text: 'The ability to have visitors in my room comfortably' },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null,
      researcher_note: 'Behavioural/logistical framing only. No clinical questions. MED subcategory derived analytically.',
    },
    {
      id: 'Q50', module: 5, section: '5D',
      intent_codes: ['MED'],
      tiers: ['professional', 'expert'],
      type: 'scale_5',
      text: {
        retrospective: 'How important was 24-hour access to food, beverages, and essential supplies during this type of stay?',
        anticipatory:  'How important is 24-hour access to food, beverages, and essential supplies during this type of stay?',
      },
      instruction: null,
      scale_labels: ['Not important', 'Slightly important', 'Moderately important', 'Very important', 'Essential'],
    ...
    // ── 5E — FAMILY [FAM] ────────────────────────────────────────────────
    {
      ...
      options: [
        ...
        { code: 'B', taxonomy_code: null, text: 'Interconnecting rooms or a proper family room option' },
        { code: 'C', taxonomy_code: null, text: 'Child-friendly food available at flexible hours' },
        { code: 'D', taxonomy_code: null, text: 'On-site facilities for children — pool, play area, or kids club' },
        { code: 'E', taxonomy_code: null, text: 'Proximity to family-oriented attractions' },
        { code: 'F', taxonomy_code: null, text: 'Staff who are genuinely welcoming and comfortable with children' },
        { code: 'G', taxonomy_code: null, text: "Baby equipment availability — cot, high chair, sterilising facilities" },
        { code: 'H', taxonomy_code: null, text: "A quiet environment appropriate for children's sleep routines" },
        { code: 'I', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 3, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q52', module: 5, section: '5E',
      intent_codes: ['FAM'],
      tiers: ['expert'],
      type: 'scale_5',
      text: {
        retrospective: 'How important was the availability of childcare or supervised activities during your stay?',
        anticipatory:  'How important is the availability of childcare or supervised activities during your stay?',
      },
      instruction: null,
      scale_labels: ['Not important', 'Slightly important', 'Moderately important', 'Very important', 'Essential to how I choose a hotel'],
      options: [], has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null, researcher_note: null,
    },

    // ── 5F — TRANSIT [TRANSIT] ───────────────────────────────────────────
    {
      id: 'Q53', module: 5, section: '5F',
      intent_codes: ['TRANSIT'],
      tiers: ['amateur', 'professional', 'expert'],
      type: 'multi_select',
      text: {
        retrospective: 'For transit stays (early flight, late arrival, long layover), what mattered most?',
        anticipatory:  'For transit stays (early flight, late arrival, long layover), what matters most?',
      },
      instruction: 'Select up to two.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'Proximity to the airport or transport hub — walking distance preferred' },
        { code: 'B', taxonomy_code: null, text: 'Seamless, fast check-in and check-out with no wait' },
        { code: 'C', taxonomy_code: null, text: 'Reliable alarm call or wake-up service' },
        { code: 'D', taxonomy_code: null, text: 'A clean room and a good shower — the stay is purely functional' },
        { code: 'E', taxonomy_code: null, text: 'Luggage storage before check-in or after check-out' },
        { code: 'F', taxonomy_code: null, text: 'Hotel shuttle service to and from the airport' },
        { code: 'G', taxonomy_code: null, text: 'A quiet room — I need to sleep quickly and reliably' },
        { code: 'H', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 2, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q54', module: 5, section: '5F',
      intent_codes: ['TRANSIT'],
      tiers: ['expert'],
      type: 'scale_5',
      text: {
        retrospective: 'For day-use or short-window stays, how important was flexible checkout time?',
        anticipatory:  'For day-use or short-window stays, how important is flexible checkout time?',
      },
      instruction: null,
      scale_labels: ['Not important', 'Slightly important', 'Moderately important', 'Very important', 'Essential — I plan my journey around it'],
      options: [], has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null, researcher_note: null,
    },

    // ── 5G — LOCAL ESCAPE [LOC-ESC] ──────────────────────────────────────
    {
      id: 'Q55', module: 5, section: '5G',
      intent_codes: ['LOC-ESC'],
      tiers: ['amateur', 'professional', 'expert'],
      type: 'multi_select',
      text: {
        retrospective: 'When booking a hotel near home as a personal escape, what motivated the choice?',
        anticipatory:  'When booking a hotel near home as a personal escape, what motivates the choice?',
      },
      instruction: 'Select up to two.',
      options: [
        { code: 'A', taxonomy_code: null, text: 'A genuine change of environment — I need to feel somewhere different' },
        { code: 'B', taxonomy_code: null, text: 'Complete separation from domestic responsibilities' },
        { code: 'C', taxonomy_code: null, text: 'Access to amenities I do not have at home — spa, pool, room service' },
        { code: 'D', taxonomy_code: null, text: 'A romantic or intimate occasion with my partner' },
        { code: 'E', taxonomy_code: null, text: 'Personal restoration — rest in a distraction-free space' },
        { code: 'F', taxonomy_code: null, text: 'A treat or reward — celebrating something personal' },
        { code: 'G', taxonomy_code: null, text: 'Other – please specify' },
      ],
      has_none_option: true, max_selections: 2, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
    {
      id: 'Q56', module: 5, section: '5G',
      intent_codes: ['LOC-ESC'],
      tiers: ['expert'],
      type: 'scale_5',
      text: {
        retrospective: 'How important was it that the hotel felt distinctly different from your everyday environment?',
        anticipatory:  'How important is it that the hotel feels distinctly different from your everyday environment?',
      },
      instruction: null,
      scale_labels: ['Not important — functional comfort is enough', 'Slightly important', 'Moderately important', 'Very important', 'Essential — the contrast is the entire point'],
      options: [], has_none_option: false, max_selections: null, routes_module_5: false, module_5_code: null, researcher_note: null,
    },
  ...
  episodes: [
    ...
    { number: 2, name: 'Before You Arrive', moduleMappings: [2], curiosityHookText: 'Expectations form before the guest walks in.',                   curiosityHookSubtext: null },
    { number: 3, name: 'Your Space',        moduleMappings: [3], curiosityHookText: 'The room matters more than guests admit.',                       curiosityHookSubtext: null },
  ...
  branching: {
    ...
    q2Routes: { A: null, B: 'LEIS-PLAN', C: 'WORK-TRANS', D: 'FAM', E: 'LEIS-EXP', F: 'MED', NONE: null },
