...
| **E2** | Data platform & PWA infra | 6 | 26 | new / partial |
| **E3** | The instrument as content | 4 | 19 | new |
| **E4** | UC-01 Agent contributes a read | 10 | 56 | new |
| **E5** | UC-02 Replay within window | 4 | 16 | new |
| **E6** | Findings Engine | 8 | 46 | new (crown jewel) |
| **E7** | UC-03 GM Findings Report | 4 | 18 | new |
| **E8** | UC-04 Researcher Console | 6 | 26 | new |
| **E9** | Observability & analytics | 3 | 11 | new / partial |
...
## 14 · Next — MDT replan (Stage 2b)

Sequence these 51 stories into sprints and gates. **Sprint count set by scope**, not the old 6/14-week container. Suggested gate logic (to confirm during the replan): *infra ready → instrument-as-content → agent read end-to-end (capture) → Findings Engine green → both locked admin surfaces → observability → iPad/QA/UAT → pilot → debrief/Phase-2*.

> **Open for your approval:** story breakdown, acceptance criteria, and the re-estimated points. On approval I'll do the **Master Development Timeline replan**.

*GuestIQ · Product Backlog v4.0 · projection / no-third-party-AI · 51 active stories · 239 SP · sprint placement pending MDT replan*
