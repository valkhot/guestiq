...
| **Document Version** | 1.2 — Reconciled to the projection/no-AI pivot (dead-model build activities replaced; researcher's expanded role + report-engine/Console activities added) |
...
| **Changes in v1.2** | Build activities reconciled: 84-path/questionnaire.js/Content-Mgmt approvals → v4.2 routing test / instrument config / Output-Spec; Sprint 2 tier/tense screens → badge/onboarding/routing; **Sprint 3** gamification → value layer + deterministic report engine + RosaeNLG; **Sprint 4** dashboard → GM report (PIN) + Researcher Console; ONGOING JSON-editing → instrument-config editing. **Researcher (SH-02) gains** report-engine integrity review + GM-reaction validation capture (Console). Sprint shape subject to the MDT replan. |
...
| Approve Output / Report-Engine Spec | **C** | **A** | — | **R** | — | — | — |
| Approve Production Readiness Architecture | **C** | **A** | — | **R** | — | — | — |
| Approve Sprint 1 architecture documents | **C** | **A** | — | **R** | — | — | — |
| Approve v4.2 routing test + report-engine integrity protocol | **C** | **A** | — | **R** | — | — | — |
| Approve instrument config (v4.2) structure | **C** | **A** | — | **R** | — | — | — |
...
| Produce v4.2 routing test spec | **I** | **A** | — | **R** | — | — | — |
| Build report-engine integrity protocol | **I** | **A** | — | **R** | — | — | — |
| Design instrument config (v4.2) structure | **I** | **A** | — | **R** | — | — | — |
| Produce UI/UX Wireframes *(deferred to design-artifact session)* | **I** | **A** | — | **R** | — | — | — |
| Produce Visual Design System *(deferred to design-artifact session)* | **I** | **A** | — | **R** | — | — | — |
| Produce API Specification | **I** | **A** | — | **R** | — | — | — |
| Produce Observability Specification | **I** | **A** | — | **R** | — | — | — |
| Produce Output / Report-Engine Spec | **I** | **A** | — | **R** | — | — | — |
...
| Build badge claim + first-run onboarding + guest-select screens | — | **A** | — | **R** | — | — | — |
| Build L1/L2 routing (9 personas → battery; party → add-on) | — | **A** | — | **R** | — | — | — |
| Build the read / answering flow from instrument config | — | **A** | — | **R** | — | — | — |
...
| **SPRINT 3 — FULL INSTRUMENT + VALUE LAYER + REPORT ENGINE** | | | | | | | |
| Build all 9 persona batteries (incl. crew, VIP) | — | **A** | — | **R** | — | — | — |
| Build PRO/EXPERT depth items + family/group add-ons | — | **A** | — | **R** | — | — | — |
| Test routing against the v4.2 routing test | — | **R** | — | **C** | — | — | — |
| Build the coverage wall (incl. completed-range) | — | **A** | — | **R** | — | — | — |
| Build badge identity (claim-and-lock, re-entry) | — | **A** | — | **R** | — | — | — |
| Build the five-beat end-of-read + depth fork | — | **A** | — | **R** | — | — | — |
| Build the RosaeNLG story (local, bounded to answers) | — | **A** | — | **R** | — | — | — |
| Build the deterministic report engine (5 gates, tag-driven, CF-sink) | — | **A** | — | **R** | — | — | — |
| Verify the report-engine integrity protocol passes (seeded) | — | **R** | — | **C** | — | — | — |
| Full instrument walkthrough — all 9 personas | — | **R** | — | — | — | — | — |
| Fix Sprint 3 bugs | — | **A** | — | **R** | — | — | — |
| **SPRINT 4 — GM REPORT & CONSOLE, QA, AND POLISH** | | | | | | | |
| Build GM report access (Ctrl+Alt+A + PIN + auto-lock + throttle) | — | **A** | — | **R** | — | — | — |
| Build the Researcher Console (six lenses, researcher PIN) | — | **A** | — | **R** | — | — | — |
| Wire the GM-reaction validation capture (Console) | — | **A** | — | **R** | — | — | — |
| Test GM report + Console (PIN, integrity lens, validation capture) | — | **R** | — | **I** | — | — | — |
| Cross-browser testing — Edge and Chrome | — | **R** | — | **I** | — | — | — |
| Test on actual front desk PC | — | **R** | — | **I** | — | — | — |
| Test on a real iPad (iOS Safari — emulation insufficient) | — | **R** | — | **I** | — | — | — |
...
| Verify the new-taxonomy PostHog events firing (badge/read/depth/end-of-read/report-opens) | — | **R** | — | **C** | — | — | **I** |
...
| Edit instrument content in config (v4.2 — text, options, gold tags) | — | **A** | — | **C** | — | — | — |
| Validate instrument config integrity (incl. gold_tag / CF-sink) | — | **A** | — | **R** | — | — | — |
| Review report-engine integrity + capture GM-reaction validation (Console) | — | **R+A** | — | **C** | — | — | — |
...
| Instrument config editing (v4.2) | **SH-02 Lead Researcher** | Research team owns instrument content + gold-tag decisions |
...
Critically, you are also Accountable for **instrument config editing** (v4.2). When instrument changes are needed — new options, revised text, gold-tag adjustments — you own that decision and the AI Developer assists with the technical implementation only if needed. You are additionally the pilot's **judge** (Researcher Value Model v0.2): you review report-engine integrity and capture the GM's reaction to each finding in the **Researcher Console** — a check for your own confidence that never gates the GM's auto-served report.
